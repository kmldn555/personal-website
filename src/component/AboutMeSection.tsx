      ...
      <div className="md:grid md:grid-cols-2 md:gap-6 md:items-start">
        <div>
          ...
          <div className="text-[16px]">
            ...
            <div className="pb-2 ">
              I also value teamwork, automated testing, and clear API design to
              help teams work efficiently and build better products together.
            </div>
            <div className="pb-2">
        ...
        <div className=" flex flex-col gap-2">
          ...
          <div className="bg-white shadow-md/10 rounded-xl flex flex-row px-4 py-3 gap-2">
            ...
            />
            <div>
              <div className="font-semibold text-5">Scalable Architecture</div>
              <div className="text-[14px]">
          ...
          <div className="bg-white shadow-md/10 rounded-xl flex flex-row px-4 py-3 gap-2">
            <img src="IconEmpathetic.svg" alt="Icon Empathetic" className="" />
            <div>
