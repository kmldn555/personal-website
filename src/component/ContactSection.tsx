...
function ContactSection() {
  return (
    <div
      id="contact"
      className="container h-full mx-auto justify-between items-center py-8 px-6 bg-[#FAF8FF] md:grid md:grid-cols-2 md:gap-6 md:items-start scroll-mt-16"
    >
      <div className="">
        ...
        <div className="flex flex-row gap-2 mt-6 items-start">
          ...
          <div>
            <div className="text-[14px] font-bold">Timezone & Availability</div>
      ...
      <div className=" flex flex-col p-4 md:mt-0 mt-4 rounded-sm shadow-sm/50 gap-4">
        ...
        <Button
          variant="outline"
          onClick={()=>{alert("Thanks for reaching out! The contact form is currently under development. Please feel free to reach out via email for now.")}}
