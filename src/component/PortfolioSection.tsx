  ...
  return (
    ...
    >
      ...
      <div className="text-[16px]">
        Projects demonstrating end-to-end execution, robust system architecture,
        and polished user interactions.
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-stretch">
        ...
        <div className="flex flex-col h-full my-2 rounded-xl shadow-sm/50">
          ...
          <div className="flex flex-col flex-1 gap-4 p-4">
            ...
            <div className="text-[16px]">
              A simple e-commerce website that allows users to browse products,
              view product details, and manage items in a shopping cart.{" "}
            </div>
            <div className="flex flex-wrap gap-2 text-[14px]">
              <div className="bg-[#E2E7FF] shadow-sm/30 rounded-sm grid justify-items-center px-2">
                React
